...
ax1.set_title("Time vs Grain Size (1200x1200 image, 2 cores)")
ax1.set_yscale("log")
ax1.set_xscale("log")
ax1.grid(True)
...
ax2.set_ylabel("Number of Tasks (log scale)")
ax2.set_yscale("log")
ax2.set_xscale("log")
ax2.set_title("Tasks vs Grain Size (1200x1200 image, 2 cores)")
ax2.grid(True)
